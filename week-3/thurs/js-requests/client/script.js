...
sayHelloButton.addEventListener('mouseover', mouseoverHelloButton);
// PROBLEM 2
/*
...
// CODE HERE
function mouseoverHelloButton(e) {
...
// CODE HERE
sayHelloButton.addEventListener('mouseout', mouseoutHelloButton);

function mouseoutHelloButton(e) {
...
/*
    ...
    Inside the repeatMyParam function above, grab the element with the id of 'repeat-text' and set its textContent 
    property equal to the response data.
...
/*
    ...
    Outside of your new function, select the button with the id "query-button" and add a click event listener that 
    calls your function.
*/

// CODE HERE
const button = document.getElementById('query-button');
button.addEventListener('click', queryTest);

function queryTest() {
  axios
    .get('http://localhost:3000/query-test?car=honda&dog=red')
...
/*
    ...
    should have a placeholder that tells the user to enter a food. And the button should indicate that it will add food into 
    a list. 
    ...
    Now make an axios post request to /food. Inside the parentheses where you passed the URL in, pass in body as the second 
    argument. 

    Use a .then to handle the promise returned from the axios call. Pass a callback function to the .then. Inside that 
    callback, console log the res.data. 
