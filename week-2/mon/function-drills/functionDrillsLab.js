...
const nameGreeting = nameCheck('Ezekiel');
...
//CODE HERE
function thatsOdd(n) {
  return n % 2 === 0 ? "That's not odd!" : 'That is odd indeed!';
}
...
//CODE HERE
// function theEliminator(arr, val) {
...
const glimmer = theEliminator(contestants, loser);
console.log(glimmer);
...
//CODE HERE
function upperPrinter(str) {
  console.log(str.toUpperCase());
}

upperPrinter(sampleString);
...
console.log(emailCheck('asdf@gmail.com  '));
...
const totalFrogs = howMany(4);
console.log(totalFrogs);

////////////////// PROBLEM 20 ////////////////////
/*
  You might have noticed a slight bug in the previous problem. If you were to pass in 4 gold, the function would return 
  to you 1.3333... However, you can't really go to a store and by 1.333 products. You would just be able to purchase 1 
  product. Re-write the function you used in the previous problem (give it the same name, just add a 2 to the end of it) 
...
const arrayIsAscending = aOrD(sampleArray);
