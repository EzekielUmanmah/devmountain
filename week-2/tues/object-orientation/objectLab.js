...
const x = { carb: 'c', fat: 'f', protein: 'p' };
ingredients(x);
...
newUser.email = 'brayn.smith@devmounta.in';
...
const tabby = new Cat('Tabby', 3, 'orange');
...
const joe = new Wizard('Joe', 23, 'fire');
joe.castSpell();
...
//Code Here
const apple = new Phone('Apple', 'iPhone 15', '50gb', 'red', 690.0);
const samsumg = new Phone('Samsung', 'Note', '60gb', 'silver', 490.0);
const nokia = new Phone('Nokia', 'nphone', '50gb', 'black', 290.0);
...
//Code Here
class Vehicle {
  constructor(capacity, color, mileage = 0) {
...
//Code Here
const myFirstVehicle = new Vehicle(4, 'blue', 10000);
...
//Code Here
const myFirstMotorcycle = new Motorcycle(2, 'black', 100, 'harley', true);
console.log(myFirstMotorcycle);

/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/
myFirstMotorcycle.move(199);
/*
...
//Code Here
const myFirstBoat = new Boat('green', 5, 100000, 'Precious', 'yacht');
