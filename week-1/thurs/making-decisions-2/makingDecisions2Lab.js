...
// What happens if you subscript to the 7th element, but there are not 7 elements in
...
// If the length is more than 7, reassign the value of 'someNum' to the value of the 7th
// element in the array. (Hint: how can you make sure that your code works for exactly 7 elements?
...
// If an index does not exist in the array, undefined is logged to the console
// To work for exactly array of length 7, if(arr.length === 7){}
